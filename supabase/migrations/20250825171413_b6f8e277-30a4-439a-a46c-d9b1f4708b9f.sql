...
-- 4. Add missing triggers that were identified in the linter
...
CREATE TRIGGER update_flavor_options_updated_at
    BEFORE UPDATE ON public.flavor_options
    FOR EACH ROW
    EXECUTE FUNCTION public.set_updated_at();

CREATE TRIGGER update_flavor_prices_updated_at
