...
-- Business owners can manage their own menu item flavors
CREATE POLICY IF NOT EXISTS "Business owners manage their menu item flavors"
...
-- Public can view allowed flavors for active menu items and active flavors
CREATE POLICY IF NOT EXISTS "Public can view allowed flavors for active menu items"
ON public.menu_item_flavors
FOR SELECT
USING (
  EXISTS (
